...
${t}`
    ...
    const gee = {
        ...
        mee = {
            ...
            GENERIC: "Ошибка при входе в игру. Скорее всего эта игра отсутсвует или выключена на сайте. Попробуй зайти через jackbox.pro или другой иной сайт.",
        ...
        Xne = ze({
            ...
            methods: {
                async load() {
                    var e;
                    try {
                        const n = await (await fetch("https://jackbox.pro/main/@connect/nanners/nanners.json")).json(),/*https://jackbox.pro/main/@connect/nanners/nanners.json*/
